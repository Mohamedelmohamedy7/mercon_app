          ...
          if (model.status == LoadingStatus.LOADING) {
            ...
            return Stack(
              children: [
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (model.unitDetailsModel?.data?.subOwnerDetails !=
                            null)
                          Card(
                            elevation: 2,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (model.showAcceptOrRejectOwnerUnit &&
                                      (data?.subOwnerDetails?.isApproved !=
                                              true &&
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (model
                                        .unitDetailsModel?.data?.denialReason !=
                                    null) ...[
                                  const SizedBox(height: 16),
                                  RejectionMessageWidget(
                                      rejectionReason: model.unitDetailsModel
                                              ?.data?.denialReason ??
                                          ""),
                                ],
                                const SizedBox(height: 16),
                                                              ...
                                                              ? Row(
                                                                  mainAxisAlignment:
                                                                      MainAxisAlignment
                                                                          .center,
                                                                  children: [
                                                                    unitDetails.statusID.toString().trim() ==
                                                                            "3"
                                                                        ? Expanded(
                                                                            child:
                                                                                Text(
                                                                      ...
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          payment.createdDate != null
                                                                              ? (DateConverter.estimatedDate(payment.createdDate!) ?? "").toString()
                                                                              : "",
                                                                          style:
                                                                              dataStyle(),
                                                                          textAlign:
                ...
                if (model.checkUnitBelongingToAnotherOwnerLoading)
