...
class ActionsScreenForSuperAdmin extends StatefulWidget {
  const ActionsScreenForSuperAdmin({Key? key}) : super(key: key);

  @override
  State<ActionsScreenForSuperAdmin> createState() =>
      _ActionsScreenForSuperAdminState();
}

class _ActionsScreenForSuperAdminState extends State<ActionsScreenForSuperAdmin>
            ...
            children: [
              ...
              containerNotification(
                  ...
                  Icon(Icons.delete_outline_sharp,
                      color: Color(0xFF695c4c).withOpacity(0.8)), () {
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              "$title".tr(),
              style: CustomTextStyle.regular14Gray
