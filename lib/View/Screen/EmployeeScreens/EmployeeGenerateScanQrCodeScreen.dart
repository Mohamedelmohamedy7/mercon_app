...
class EmployeeGenerateScanQrCodeScreen extends StatefulWidget {
  const EmployeeGenerateScanQrCodeScreen({Key? key,this.needBack=false}) : super(key: key);
  final bool needBack;
  @override
  State<EmployeeGenerateScanQrCodeScreen> createState() => _State();
}

class _State extends State<EmployeeGenerateScanQrCodeScreen> {
  @override
  void initState() {
    Provider.of<QrcodeProvider>(context, listen: false).generateQrCodeForEmployee(context);
    super.initState();
  }
