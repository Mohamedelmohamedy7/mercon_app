class VisitorsNotExitResponse {
  final String? message;
  final List<VisitorNotExitData>? data;
  ...
  factory VisitorsNotExitResponse.fromJson(Map<String, dynamic> json) {
    return VisitorsNotExitResponse(
      message: json['message'],
      data: (json['data'] as List<dynamic>?)
          ?.map((x) => VisitorNotExitData.fromJson(x))
          .toList(),
    );
  }
...
class VisitorNotExitData {
  ...
  factory VisitorNotExitData.fromJson(Map<String, dynamic> json) {
    return VisitorNotExitData(
      id: json['id'],
      name: json['name'],
      nameAr: json['nameAr'],
      nameEn: json['nameEn'],
